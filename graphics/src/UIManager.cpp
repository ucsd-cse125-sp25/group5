...
static std::unordered_map<std::string, std::tuple<std::string, GamePhase, float, float, float, float>> UIStorage = {
	...
	{"defeat", {PROJECT_SOURCE_DIR + std::string("/assets/end_defeat.png"), GamePhase::POST_GAME, 0.5, 0.5, 0.35, 0.5}},
	{"victory", {PROJECT_SOURCE_DIR + std::string("/assets/end_victory.png"), GamePhase::POST_GAME, 0.5, 0.5, 0.35, 0.5}},
