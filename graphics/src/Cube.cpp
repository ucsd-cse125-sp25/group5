...
void Cube::create(glm::vec3 cubeMin, glm::vec3 cubeMax, glm::mat4 new_model) {
    // Model matrix.
	model = new_model;
...
void Cube::update(glm::vec3 cubeMin, glm::vec3 cubeMax, glm::mat4 new_model) {
    ...
    //this->create(cubeMin,cubeMax,new_model);
    // Model matrix.
	model = new_model;
