...
void Skybox::initSkybox() {
    ...
    glBufferData(GL_ARRAY_BUFFER, skyboxVertices.size(), &skyboxVertices, GL_STATIC_DRAW);
...
void Skybox::draw(Camera* cam) {
    ...
    // TODO: use shader
    // shader.use() If we use a custom shader class
    // TODO: get view and projection matrix from camera 
