...
void main() 
{
    ...
    float fogWeight = (1.0/exp(fogConstant*length(vec3(pow(sqrt(dir.x * dir.x + dir.z * dir.z), 3.0) * 36.0, sqrt(max(0, abs(dir.y))) * 3.0, pow(sqrt(dir.x * dir.x + dir.z * dir.z), 3.0) * 36.0))));
