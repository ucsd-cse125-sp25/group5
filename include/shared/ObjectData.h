...
std::make_tuple("Directional Light", glm::vec3(0.f, 3.f, 0.f), ".obj"),
...
std::make_tuple("lantern_1", glm::vec3(-38.70001f, 37.15f, -0.3499756f), ".obj"),
std::make_tuple("lantern_1", glm::vec3(-13.10001f, 43.19001f, -28.04004f), ".obj"),
std::make_tuple("lantern_1", glm::vec3(-2.700012f, 47.19001f, -7.060059f), ".obj"),
std::make_tuple("lantern_1", glm::vec3(38.79999f, 49.76f, -12.34998f), ".obj"),
std::make_tuple("lantern_1", glm::vec3(31.79999f, 53.26f, 3.599976f), ".obj"),
std::make_tuple("lantern_1", glm::vec3(21.f, 51.86f, -22.79004f), ".obj"),
std::make_tuple("lantern_1", glm::vec3(17.21997f, 48.03f, -7.650024f), ".obj"),
...
std::make_tuple("lantern_1", glm::vec3(-35.79999f, 100.28f, -0.3499756f), ".obj"),
std::make_tuple("lantern_1", glm::vec3(-13.10001f, 102.56f, -25.09998f), ".obj"),
std::make_tuple("lantern_1", glm::vec3(-10.70001f, 110.32f, -7.060059f), ".obj"),
std::make_tuple("lantern_1", glm::vec3(15.59998f, 111.16f, -6.839966f), ".obj"),
std::make_tuple("lantern_1", glm::vec3(21.f, 113.76f, -22.79004f), ".obj"),
std::make_tuple("lantern_1", glm::vec3(31.79999f, 116.39f, 3.599976f), ".obj"),
