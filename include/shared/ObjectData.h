...
const static std::vector<std::tuple<std::string, glm::vec3, std::string>> mapObjects = {
	/*std::make_tuple("default", glm::vec3(15.59998f, 111.16f, -6.83997f), ".obj"),
std::make_tuple("default", glm::vec3(-10.70001f, 110.32f, -7.06006f), ".obj"),
std::make_tuple("default", glm::vec3(-13.10001f, 43.19001f, -28.04004f), ".obj"),
std::make_tuple("default", glm::vec3(-26.20001f, 117.16f, 22.80005f), ".obj"),
std::make_tuple("default", glm::vec3(21.f, 113.76f, -22.79004f), ".obj"),
std::make_tuple("default", glm::vec3(21.f, 51.86f, -22.79004f), ".obj"),
std::make_tuple("default", glm::vec3(17.21997f, 48.03f, -7.65002f), ".obj"),
std::make_tuple("default", glm::vec3(-17.01999f, 41.26f, 29.40002f), ".obj"),
std::make_tuple("default", glm::vec3(-42.02002f, 36.68001f, 21.5f), ".obj"),
std::make_tuple("default", glm::vec3(31.79999f, 53.26f, 3.59998f), ".obj"),
std::make_tuple("default", glm::vec3(0.f, 33.56f, 13.90002f), ".obj"),
std::make_tuple("default", glm::vec3(-19.10001f, 96.31f, 10.40002f), ".obj"),
std::make_tuple("default", glm::vec3(-35.79999f, 100.28f, -0.34998f), ".obj"),
std::make_tuple("default", glm::vec3(-26.20001f, 45.86f, 22.80005f), ".obj"),
std::make_tuple("default", glm::vec3(-42.02002f, 99.81f, 23.59998f), ".obj"),
std::make_tuple("default", glm::vec3(-17.01999f, 104.39f, 27.5f), ".obj"),
std::make_tuple("default", glm::vec3(-13.10001f, 102.56f, -25.09998f), ".obj"),
std::make_tuple("default", glm::vec3(0.f, 96.68999f, 13.30005f), ".obj"),
std::make_tuple("default", glm::vec3(31.79999f, 116.39f, 3.59998f), ".obj"),
std::make_tuple("default", glm::vec3(41.29999f, 105.16f, -12.34998f), ".obj"),
std::make_tuple("default", glm::vec3(-2.70001f, 47.19001f, -7.06006f), ".obj"),
std::make_tuple("default", glm::vec3(-38.70001f, 37.15f, -0.34998f), ".obj"),
std::make_tuple("default", glm::vec3(38.79999f, 49.76f, -12.34998f), ".obj"),
std::make_tuple("default", glm::vec3(-19.10001f, 33.18001f, 14.80005f), ".obj"),*/
